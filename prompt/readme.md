...
#### amz
thinking_template = """You are an expert recommender engine. Your task is to determine if the user will like the target book.
...
##################### fine-tune #####################
#### amz
thinking_template = """You are an expert recommender engine. Your task is to inference the user preference.
...
#####################dataset construction#####################
#### movie
thinking_template = """You are an expert recommender engine. Your task is to determine if the user will like the target movie.
...
#####################dataset construction#####################
#### amz
thinking_prompt = """You are an expert recommender engine. Your task is to determine if the target user will like the target book.
...
##################### fine-tune #####################
#### amz
thinking_prompt = """You are an expert recommender engine. Your task is to inference knowledge about the target book.
...
#####################dataset construction#####################
#### movie
thinking_prompt = """You are an expert recommender engine. Your task is to determine if the target user will like the target movie.
...
##################### fine-tune #####################
#### movie
thinking_prompt = """You are an expert recommender engine. Your task is to inference knowledge about the target movie.
